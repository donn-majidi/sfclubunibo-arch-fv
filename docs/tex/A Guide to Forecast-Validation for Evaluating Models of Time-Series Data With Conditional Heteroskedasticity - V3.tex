...
\begin{document}
	...
	\end{align}
	In the expression above, the constant $c_i$ is set to $2$ for the stationary bootstrap and $4/3$ for the circular and the moving block bootstrap.
